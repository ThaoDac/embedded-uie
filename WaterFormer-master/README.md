# Resize + manual tiling (thường không cần thiết)
python app_console.py --input ... --output ... --resize 512 --tile 256

# Chỉ định model path khác
python app_console.py --input ... --output ... --model ./checkpoints/model.pth --resize 256

# Chạy trên CPU
python app_console.py --input ... --output ... --device cpu --resize 256
