...
parser.add_argument("--data_dir", type=str, default="/home/ndpthao/eject/IMPLEMENTATION/FUnIE-GAN-main/static/uploads/")
parser.add_argument("--sample_dir", type=str, default="/home/ndpthao/eject/IMPLEMENTATION/FUnIE-GAN-main/static/results/")
parser.add_argument("--model_name", type=str, default="funiegan") # or "ugan"
parser.add_argument("--model_path", type=str, default="/home/ndpthao/eject/IMPLEMENTATION/FUnIE-GAN-main/PyTorch/models/funie_generator.pth")
